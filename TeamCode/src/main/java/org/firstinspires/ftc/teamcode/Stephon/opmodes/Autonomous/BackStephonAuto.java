...
public class BackStephonAuto extends SelectableOpMode {

    public BackStephonAuto() {
...
class BackRedAuto extends OpMode {
    ...
    public void init() {
        ...
        // Initialize Pedro Pathing Follower using Constants
        follower = Constants.createFollower(hardwareMap);
        // TODO: Update starting pose for red alliance based on field layout
        follower.setStartingPose(new Pose(63.01182654402103, 9.5, Math.toRadians(90)));
    ...
    public static class Paths {
        ...
        public Paths(Follower follower) {
            ...
            // ========== FIRST ROW (Tag 21 - PPG) ==========
            // TODO: Update with red alliance trajectories
            FirstRow_PickUp = follower
                    .pathBuilder()
                    .addPath(
                            new BezierCurve(
